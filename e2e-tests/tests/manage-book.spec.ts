...
test("should display books", async({page}) =>{
  ...
  await expect(page.getByText("Test Add Book").first()).toBeVisible();
  await expect(page.getByText("Test description for add book!").first()).toBeVisible();
  await expect(page.getByText("Test City,Test Community").first()).toBeVisible();
  await expect(page.getByText("Art").first()).toBeVisible();
  await expect(page.getByText("CAD20 per week").first()).toBeVisible();
  await expect(page.getByText("16-17 years").first()).toBeVisible();
